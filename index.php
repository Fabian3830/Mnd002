...
<body>
 ...
 if (!$conn) {
    ...
    trigger_error(htmlentities($e['message'], ENT_QUOTES), E_USER_ERROR);
        ...
        $sql = "select * from TB_ARTICULO where nombre != :correo  ";
        ...
        $a='1'  ;
        oci_bind_by_name($stid, ':correo', $a);
        oci_execute($stid);
       ...
       var_dump($retorno["valido"]);


        /*while (($row = oci_fetch_assoc($stid)) != false) {
     $JEJE =  '<div class="col-lg-4 col-md-6 mb-4">';
     $JEJE .= '<div class="card h-100">';
     $JEJE .=    '<a href="#"><img class="card-img-top" src="'.$row['IMG'].'" alt=""></a>';
